    ...
    $(function() {
        ...
        if (dt_user_table.length) {
            var dt_user = dt_user_table.DataTable({
                ajax: "<?= base_url() . $this->uri->segment(1) . '/getData' ?>", // JSON file to add data
                columns: [{
                        data: 'id'
                    },
                    {
                ...
                buttons: [{
                    ...
                    {
                        text: '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Tambah Guru</span>',
