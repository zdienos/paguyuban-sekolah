...
<head>
    <!-- <base href="../"> -->
    <base href="<?=base_url('assets/_templates/')?>">
    <meta charset="utf-8">
    <meta name="author" content="zdienos">
...
<body class="nk-body bg-lighter npc-default has-sidebar ">
    <div class="nk-app-root">
        ...
        <div class="nk-main ">
            ...
            <!-- sidebar @s -->
            <?php $this->load->view('_templates/sidebar.php')?>
            <!-- sidebar @e -->
                    ...
                    <div class="container-fluid">
                        <div class="nk-content-inner">
                            <div class="nk-content-body">                                
                                <?php $this->load->view('_templates/content.php')?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="nk-footer">
                    <div class="container-fluid">
                        <div class="nk-footer-wrap">
                            <div class="nk-footer-copyright"> &copy;2022 AMS - Asset Management System by <a href="https://ams.transstudiomall.com" target="_blank">AMS</a>
                            </div>                            
                        </div>
                    </div>
                </div>
